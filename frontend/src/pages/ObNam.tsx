    ...
    <div className="container">
      <section className="about-us">
        ...
        <ol className="about-us__contetns">
          <li>
            <a href="#">История возрождения</a>
          </li>
          <li>
            <a href="#">Во что мы верим</a>
          </li>
          <li>
            <a href="#">Интересные факты об нас</a>
          </li>
          <li>
            <a href="#">
              Как <span>докатиться</span> вступить в наши ряды
            </a>
          </li>
          <li>
      ...
      {data &&
        data.map((d) => (
          <section className="about-us">
            ...
            <a href="#contents" className="about-us__goto-contents">
