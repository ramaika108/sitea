        ...
        <div className="horoscope__content">
          <div className="content__wheel">
            ...
            <img
              ...
              alt="Стрелка судьбы"
              style={{
                transform: showDetails ? `rotate(${randomAngle}deg)` : "none",
              }}
            />
            {!showDetails && (
              <button className="horoscope_button" onClick={showNew}>
                Крутнуть
              </button>
            )}
          </div>
          <div className="content__desc">
            <p>
              {showDetails
                ? "Приходите за следующим предсказанием завтра"
                : "Внимание этот очень технологичный прибор может предсказать то как пройдет ваш день. Предупреждаю, его предсказания сбываются всегда, как говорится “Не сегодня так завтра...”"}
            </p>
            <img src={calendarezki} alt="Опереатор гороскопа" />
            {showDetails && (
              <div className="horoscope-detail-wrapper">
