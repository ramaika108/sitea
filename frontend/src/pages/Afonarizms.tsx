    ...
    <main className="afonarizm-page" id="top">
      <div className="container">
        ...
        <div className="row afonarizm-page__content">
          {afonarizms &&
            afonarizms.afonarizms.map((afonarizm: Afonarizm) => (
              <div
                className="col-xl-4 col-md-6 col-sm-6 afonarizm-page__item"
                key={afonarizm.id}
              >
                <div
                  className="afonarizm-page__item-wrap"
                  style={{ transform: `rotate(${randomInt(-5, 5)}deg)` }}
                >
                  <p>{afonarizm.body}</p>
        ...
        <Pagination
          pagination={afonarizms?.pagination}
          color="light"
          extraClass="afonarizm-page-pagination"
        />
      </div>
    </main>
  );
