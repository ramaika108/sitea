    ...
    <main className="humor-pump-page" id="top">
      <div className="container">
        ...
        <div className="row humor-pump-page__content">
          {puddles &&
            puddles.puddles.map((puddle: Puddle) => (
              <div
                className="col-xl-4 col-md-6 col-sm-6 humor-pump-page__item"
                key={puddle.id}
              >
                <div
                  className="humor-pump-page__item-wrap"
                  style={{
                    transform: `rotate(${randomInt(-5, 5)}deg)`,
                    borderRadius: `${randomInt(30, 130)}px ${randomInt(
                      30,
                      130,
                    )}px ${randomInt(30, 130)}px ${randomInt(30, 130)}px`,
                  }}
                >
                  <p>{puddle.body}</p>
        ...
        <Pagination
          pagination={puddles?.pagination}
          color="light"
          extraClass="humor-pump-page-pagination"
        />
      </div>
    </main>
  );
