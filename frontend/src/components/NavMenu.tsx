...
const NavMenu = () => {
  ...
  const pages: Dictionary<Page> = {
    "/": {
      ...
      img: img1,
      info: "Следы виданных зверей ↑",
    },
    "/afonarizms": {
      text: "Афонаризмы",
      img: img2,
      info: "Афонаризмы, это такие бумажки с закарючками, которые раньше приклеиввли под фонарики",
    },
    "/horoscope": {
      text: "Гороскоп",
      img: img3,
      info: "Гороскоп это прибор для наблюдения за горами",
    },
    "/blohs": {
      text: "Блох",
      img: img4,
      info: "Нам на сайте блох не нужен!",
    },
    "/kolonka": {
      text: "Колонка",
      img: img5,
      info: "Ходють тут всякие, топчуть!",
    },
    "/ob-nam": {
      text: "Об нам",
      img: img6,
      info: "Не ловись рыбка никакая, мы тебя все равно не едим...",
    },
  };
      ...
      <ul className="top-menu">
        {Object.keys(pages).map((page) => {
          if (activePage?.text === pages[page].text) {
            return (
              <li key={page} className="top-menu__item--active">
                {pages[page].text}
              </li>
            );
          }
          return (
            <li key={page}>
              <Link to={page} className="ez-link">
                {pages[page].text}
              </Link>
            </li>
          );
    ...
    <header className="main-header">
      <div className="container">
        <div className="row main-header__top">
          ...
          <div className="col-md-8 main-header__right">{navMenu}</div>
        </div>
        <div className="row">
