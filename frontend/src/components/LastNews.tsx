      ...
      <section className="last-news">
        <div className="last-news__heading-wrapper">
          ...
          <div className="ez-heading">
            ...
            <p>
              (Людских границ ежи не признают и вольно перемещаются по всему
              земному шарику или блинчику. Ежинное Государство находится везде
              где есть ежики, то есть во всем мире кроме Австралии.{" "}
              <Link to="/ob-nam">Подробности туточки</Link>)
            </p>
          </div>
        ...
        {!posts && (
          <div className="bloh__alert">
            <h3>Ловим блохов...</h3>
          </div>
        )}

        <Link to="blohs" className="ez-link">
          <div className="show-more">Что там еще новенького...</div>
        </Link>
      </section>
    </div>
  );
