  ...
  return (
    <div className="row d-none d-lg-flex">
      ...
      <div className="col-md-4 col-sm-6 col-xs-6 main-footer__item">
        <p>
          Этот сайт вместе с его содержимым охраняется авторским правом и левом,
          а еще пищащими воротами как в магазине или метре (во как!)
        </p>
      ...
      <div className="col-md-4 col-sm-6 col-xs-6 main-footer__item">
        <p>
          Хотите поддержать проект или просто узнать о нас побольше? Тыкайте
          сюда ↓
        </p>
      ...
      <div className="col-md-4 col-sm-6 col-xs-6 main-footer__item">
        <p>
          Есть вопрос, жалоба, или дельное предложение? Не стесняйся пиши нам на
          почту, слава Богу, почтовые голуби у нас пока есть, тфу тфу тфу.{" "}
          <a href="#" className="ez-link">
            zalobi_i_ne_toko@ezichestvo.ru
          </a>
        </p>
